...
class load_to_mysql():
    ...
    def save_to_mysql(self):
        ...
        # Create the table
        mycursor.execute(
            "CREATE TABLE IF NOT EXISTS posts_for_inference (submission_id VARCHAR(255), comment_id VARCHAR(255), timestamp TIMESTAMP, author VARCHAR(255), body TEXT, submission TEXT, upvotes VARCHAR(255), upvote_ratio VARCHAR(255), date DATE)"
        )
